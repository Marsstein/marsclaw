...
// RunWizard runs an interactive setup wizard that creates ~/.liteclaw/config.yaml.
func RunWizard() error {
	home, _ := os.UserHomeDir()
	dir := filepath.Join(home, ".liteclaw")
	...
	b.WriteString("# LiteClaw configuration\n")
	b.WriteString("# Generated by: liteclaw init\n\n")
	...
	fmt.Println("\nRun 'liteclaw' to start chatting.")
	return nil
}
